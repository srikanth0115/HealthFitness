...
public class ParticlesDrawable extends Drawable implements Animatable, Runnable {
    ...
    private static final int DEFAULT_DOT_NUMBER = 160;
    ...
    private static final int DEFAULT_DOT_COLOR = 0xFF00aff0;

    private static final int DEFAULT_LINE_COLOR = 0xFF00aff0;
